...
import com.example.shoptry.dto.ItemFormDto;
...
class ItemServiceTest {
    ...
    List<MultipartFile> createMultipartFiles() throws Exception{
        ...
        for(int i=0;i<5;i++){
            String path = "/Users/master/IdeaProjects/shopSpringBootBook/shopTry/src/main/resources/static/images";
    ...
    void saveItem() throws Exception {
        ...
        assertFalse(itemImgList.isEmpty(), "itemImgList should not be empty");
